//atrapapr la dirección de ngrok, solo se le tiene que mover el ip
const NGROK = `https://${window.location.hostname}`;
//nuevo socket con dir url
let socket = io(NGROK, { path: '/real-time' });
console.log('Server IP: ', NGROK);

//guardar variables que voy a recibir
...
//leyendo mupi instructions
socket.on('mupi-instructions', instructions => {
    console.log('ID: ' + socket.id);
//manda un numero y lo mete al switch y en cada caso hago una interacción específica
